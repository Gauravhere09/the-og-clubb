...
import { JoinIdeaDialog } from "./JoinIdeaDialog";
import { useIdeaJoin } from "./useIdeaJoin";
...
export function IdeaDisplay({ idea, postId }: IdeaDisplayProps) {
  ...
  // Debugging
  useEffect(() => {
    console.log("IdeaDisplay render:", {
      ideaTitle: idea.title,
      participants: participants.length,
      isCurrentUserJoined,
      postId
    });
  }, [idea.title, participants.length, isCurrentUserJoined, postId]);
