...
const reactionIcons = {
  ...
  'wow': <svg className="h-3 w-3 text-purple-500" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="2" fill="currentColor" fillOpacity="0.5"/>
    <circle cx="12" cy="12" r="4" fill="currentColor"/>
    <circle cx="8" cy="9" r="1.5" fill="white"/>
    <circle cx="16" cy="9" r="1.5" fill="white"/>
  </svg>,
  'sad': <svg className="h-3 w-3 text-yellow-300" viewBox="0 0 24 24">
